...
''' 
    ...
    1. there must be one and only one inductive loop located 200m upstream and downstream to each on-ramps
...
NET_PATH = WORK_PATH + "/net/turnpike/turnpike.single.net.xml"
...
class LoopGenerator(SumoNet):
    ...
    def write_detectors_to_net(self, multiclass=False, savepath=WORK_PATH+"/net/turnpike/turnpike.single.w_detectors.additional.xml"):
