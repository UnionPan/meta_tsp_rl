...
def env(**kwargs):
    env = TurnpikeEnvironmnet(**kwargs)
...
class TurnpikeEnvironmnet(gym.Env):
    """
    ...
    def __init__(self, 
        ...
        self.label = str(TurnpikeEnvironmnet.CONNECTION_LABEL)
        TurnpikeEnvironmnet.CONNECTION_LABEL += 1
        self.sumo = None
        self.vsl_files = '/nets/turnpike_single/net/turnpike/vsl2.0',
        self.run = 0
