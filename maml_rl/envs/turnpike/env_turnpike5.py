...
FLOW_GENERATOR = SumoNet('D:\\Productivity\\PythonProjects\\meta_tsp_rl-main/maml_rl/envs/turnpike/nets/turnpike_single/net/turnpike/turnpike.single.net.xml')
...
class TurnpikeEnvironment(gym.Env):
    ...
    def __init__(self, 
        ...
        self.detectors = conn.inductionloop.getIDList()
        ...
        self.observation_space = Box(
            low=0, high=1, shape=(len(self.detectors), ))
